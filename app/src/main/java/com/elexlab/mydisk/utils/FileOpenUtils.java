...
public class FileOpenUtils {
    ...
    public static void openFile(Context context, String file) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
                ...
                intent.setDataAndType(Uri.fromFile(new File(file)), getMIMEType(file));
    ...
    public static boolean isImage(String fileName){
        ...
        return isSomeMime (fileName,"image");
    }
    public static boolean isVideo(String fileName){

        return isSomeMime (fileName,"video");
    }
    public static boolean isAudio(String fileName){

        return isSomeMime (fileName,"audio");
    }
    private static boolean isSomeMime(String fileName,String key){
